            ...
            <form>
              <div class="form-row">
                <div class="col-12 col-md-9 mb-2 mb-md-0">
                  <input v-model="criterioBusqueda" type="text" class="form-control form-control-lg busqueda" placeholder="Busque Por Nombre de Auto ej : FIAT-600" />
                </div>
      ...
      <!--       <div class="row">
        <div v-for="(producto, index) in productosFiltrados" :key="index" class="col-lg-4 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              <p class="card-text">
                {{ agregarSignoPesos(producto.venta) }}
              </p>
            </div>
...
export default {
  ...
  computed: {
    productosFiltrados() {
      ...
      return productos.filter(producto => {
        ...
        return registroCompleto.toUpperCase().includes(this.criterioBusqueda.toUpperCase());
      });
    },
    listaPedidosLength() {
  ...
  methods: {
    ...
    agregarProductoAlPedido(producto) {
      const fromArray = this.productosPedido.find(itemPedido => itemPedido.producto.productoid === producto.productoid);
      if (fromArray) {
        fromArray.cantidad++;
      } else {
        const itemPedido = {
